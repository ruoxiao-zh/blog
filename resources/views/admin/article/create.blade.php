...
@section('content')
    ...
    <form class="form-horizontal " action="{{ url('blog/admin/article/store') }}" method="post">
        {{ csrf_field() }}
        <table class="table table-striped table-bordered table-hover">
            <tr>
                <th width="7%" style="text-align: center;">分类</th>
                <td>
            ...
            <tr>
                <th style="text-align: center;display: table-cell;vertical-align: middle;margin: 0 auto;">作者{{ $author }}</th>
                <td>
            ...
            <tr>
                ...
                <td>
                    @foreach($tag as $v)
                        {{ $v['name'] }}&nbsp;
                        <input class="bjy-icheck" type="checkbox" name="tag_ids[]" value="{{ $v['id'] }}" @if(in_array($v['id'], old('tag_ids', []))) checked="checked" @endif>
                        &emsp;
                    @endforeach
                </td>
            </tr>
