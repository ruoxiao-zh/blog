...
<head>
    <meta charset="UTF-8">
    <title>@yield('title') - Ellison`s Blog</title>
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{ url('blog/admin/index/index') }}" class="site_title">&nbsp;🍁&nbsp;<span>Ellison`s Blog</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/article/index') }}">文章列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-th"></i> 分类管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/category/index') }}">分类列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-tags"></i> 标签管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/tag/index') }}">标签列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-comments"></i> 评论管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/comment/index') }}">评论列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-users"></i> 用户管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/user/index') }}">管理员列表</a></li>
                                    <li><a href="{{ url('blog/admin/oauthUser/index') }}">第三方用户列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-link"></i> 友情链接 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/friendshipLink/index') }}">友情链接列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-commenting"></i> 随言碎语 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/chat/index') }}">随言碎语列表</a></li>
                                </ul>
                            </li>
                            <li>
                                <a><i class="fa fa-cogs"></i> 系统设置 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{ url('blog/admin/config/edit') }}">设置列表</a></li>
                                    <li><a href="{{ url('blog/admin/gitProject/index') }}">开源项目</a></li>
                                    <li><a href="{{ url('blog/admin/config/clear') }}">清空缓存</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="sidebar-footer hidden-small">
                    <a href="{{ url('blog/admin/config/edit') }}" data-toggle="tooltip" data-placement="top" title="Settings">
                    ...
                    <a href="{{ url('blog/admin/login/logout') }}" title="Logout">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="{{ url('blog/admin/login/logout') }}"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
