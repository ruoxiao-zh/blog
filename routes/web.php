...
// Home模块下 三级模式
Route::group(['namespace' => 'Home', 'prefix' => 'blog/home'], function () {
    // 迁移数据
...
// auth
Route::group(['namespace' => 'Auth', 'prefix' => 'blog/auth'], function () {
    // 第三方登录
...
// 后台登录页面
Route::group(['prefix' => 'blog/admin', 'namespace' => 'Admin'], function () {
    Route::group(['prefix' => 'login'], function () {
        // 登录页面
        Route::get('index/index/index/index/index', 'LoginController@index')->middleware('admin.login');
        // 退出
...
// Admin 模块
Route::group(['namespace' => 'Admin', 'prefix' => 'blog/admin', 'middleware' => 'admin.auth'], function () {
    // 首页控制器
 ...
 * 各种钩子
 */
Route::group(['prefix' => 'blog/hook', 'namespace' => 'Hook'], function () {
    // 开源中国
