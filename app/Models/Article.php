...
class Article extends Base
{
    ...
    public function getHomeList($map = [])
    {
        ...
        $data = $this
            ->whereMap($map)
            ->select('articles.id', 'articles.title', 'articles.cover', 'articles.author', 'articles.click', 'articles.description', 'articles.category_id', 'articles.created_at', 'c.name as category_name')
